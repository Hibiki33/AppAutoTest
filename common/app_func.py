...
from read_json import get_json_value

class AppFunc:
    
    def __init__(self, driver, app_file_json_data):
        self.driver = driver
        self.access_button = AppOp(get_json_value(app_file_json_data, "access_button"))
        self.search_frame_id = AppOp(get_json_value(app_file_json_data, "search_frame_id"))
        self.search_edit_bar = AppOp(get_json_value(app_file_json_data, "search_edit_bar"))
        self.search_button = AppOp(get_json_value(app_file_json_data, "search_button"))
        self.exit = AppOp(get_json_value(app_file_json_data, "exit"))
        tasks = get_json_value(app_file_json_data, "tasks")
        self.tasks = {}
